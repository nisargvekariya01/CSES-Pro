function u(){if(!window.location.href.includes("/task/"))return;const a=document.querySelector(".content");if(!a)return;const l=a.querySelectorAll("pre");if(l.length===0)return;const d=document.createElement("style");d.textContent=`
    .cses-cf-box {
